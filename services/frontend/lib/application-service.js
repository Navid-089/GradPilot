...
export const applicationService = {
  ...
  async getUserApplications() {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/recommendations/applications`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async removeApplication(scholarshipId) {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/recommendations/applications/remove`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  async hasUserApplied(scholarshipId) {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/recommendations/applications/check/${scholarshipId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
