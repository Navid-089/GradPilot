...
// Use localhost for browser requests since the browser runs on the host machine
const API_URL = "http://localhost:8082"; // Use localhost for browser/client-side requests
